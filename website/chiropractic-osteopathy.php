...
<section id="chiropractic-osteopathy" class="cf">
  ...
  <div class="chiropractic-osteopathy-left">
    ...
    <ul>
      <li>Back pain</li>
      <li>Decreased ability to exercise due to pain or lack of motion</li>
      <li>Decreased ability to jump</li>
    </ul>
  </div>
  <div class="chiropractic-osteopathy-mid">
  	<img class="animal-heads" src="_images/dog.png" alt="dog silhouette"><h3>Dogs</h3>
    <ul>
      <li>Back pain</li>
      <li>Fear or aggression due to pain - symptoms include skin twitching over the back, doesn't allow back to be touched</li>
      <li>Decreased ability to jump or play</li>
    </ul>
  </div>
